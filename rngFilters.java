...
public class rngFilters{
	 ...
	 *
	 */
	public static int elements = 15000; // m
	public static int elements2= 10000;
	public static int elements3= (elements+elements2)/2;
	public static double p = 0.01;
	public static final int NUMBER_RANGE = 100000; // random number range
	public static int fixed_bitsize  = (int) (NUMBER_RANGE);
	//public static int bitsize2  = (int) Math.ceil((elements * Math.log(1/p)) / Math.pow(Math.log(2), 2)); // n

	//public static int bitsize  = (int) Math.ceil(-1 * (elements3 * Math.log(p)) / Math.pow(Math.log(2), 2)); // n
	...
	//public static int rngelements3 = (rngelements1+rngelements2)/2;
	//public static int bitsize  = (int) Math.ceil((rngelements3 * Math.log(1/p)) / Math.pow(Math.log(2), 2));// n
	//public static int bitsize  = (int) Math.ceil(-1 * (rngelements3 * Math.log(p)) / Math.pow(Math.log(2), 2)); // n


	//public static int fixed_bitsize  = (int) (rngelements1 *14.3776);

	//System.out.println("set 1 size: "+rngelements1);
	//System.out.println("set 2 size: "+rngelements2);
	
	//public static final int NUMBER_RANGE = 1000; // random number range
	...
	public static void main(String[] args) {
	    /*int min = 1;
	    int max = NUMBER_RANGE;
	    Random random1 = new Random();
		int rngelements1 = random1.nextInt(max + min) + min;
		int rngelements2 = random1.nextInt(max + min) + min;
		System.out.println("set 1 size: "+rngelements1);
		System.out.println("set 2 size: "+rngelements2);*/
		
		//System.out.println("fixed bitsize: "+ fixed_bitsize);
		System.out.println("set 1 size: "+rngelements1);
		System.out.println("set 2 size: "+rngelements2);
